// Version: 2026-04-21-T1305 (Final Stabilization)
// =============================================
console.log('%c 🚀 Dashboard Version: 2026-04-21-T1305 (v1355)', 'color: #3b82f6; font-weight: bold; font-size: 14px;');
...
let sessionFeedbackProvided = new Set(); // Track feedback given in this session (v1355)
var trackingInterval = null;
var isPaused = false;
var pausedElapsed = 0;
let globalStudyData = { topics: {}, sessions: [], completedTasks: [] };
...
function renderStreakBadge() {
  ...
  // Update Sidebar
  if (sidebarBadge) {
    sidebarBadge.innerHTML = `<span>${flame}</span> ${current} day${current !== 1 ? 's' : ''}`;
