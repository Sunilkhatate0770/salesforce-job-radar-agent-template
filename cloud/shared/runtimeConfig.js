export const sharedRuntimeDefaults = Object.freeze({
  ...
  LINKEDIN_FETCH_PROVIDERS: "direct,apify",
  LINKEDIN_MIN_RESULTS_PER_RUN: "20",
  LINKEDIN_PAID_FALLBACK_ONLY: "true",
  LINKEDIN_APIFY_SOURCES: "curious_coder~linkedin-jobs-scraper:urls,worldunboxer~rapid-linkedin-scraper:query_location",
  LINKEDIN_PLANS_PER_RUN: "3",
  LINKEDIN_MAX_ITEMS_PER_PLAN: "90",
  LINKEDIN_MAX_URLS_PER_PLAN: "3",
  LINKEDIN_POLL_ATTEMPTS: "12",
  LINKEDIN_DIRECT_MAX_PAGES: "3",
  LINKEDIN_DIRECT_PAGE_SIZE: "25",
  LINKEDIN_DIRECT_KEYWORDS_PER_PLAN: "3",
  LINKEDIN_POSTS_QUERIES_PER_RUN: "6",
  LINKEDIN_POSTS_PAGES_PER_QUERY: "2",
  LINKEDIN_POSTS_SEARCH_PROVIDERS: "duckduckgo,brave",
  ...
  RESUME_PACK_QUEUE_ENABLED: "true",
  RESUME_PACK_FOLLOWUP_ENABLED: "true",
  RESUME_PACK_QUEUE_MAX_ITEMS: "3",
