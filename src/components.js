...
Object.assign(window, {
  ...
  buildCareerOsActions,
  buildDailyCockpitData,
  buildProfileFocus,
  careerOsFormatCount,
  careerOsFormatDate,
  careerOsFormatHours,
  careerOsSaveTopRoles,
  componentEscapeAttr,
  componentEscapeHtml,
  componentEscapeJsArg,
  componentFindJob,
  componentFormatDate,
  componentInitials,
  componentList,
  ...
  componentText,
  extractIndustrialTopicName,
  generateInitialsAvatar,
  getCareerIntelligence,
  getCareerOsDisplayName,
  getCareerOsFocus,
  getCareerOsJobDate,
  getCareerOsJobSnapshot,
  getCareerOsLastScanLabel,
  getCareerOsMatchQuality,
  getCareerOsPrepCategories,
  getCareerOsScore,
  getCareerOsStudySnapshot,
  getCareerOsTodayKey,
  getCareerOsTopicId,
  getCareerOsTopicName,
  getFollowUpStatus,
  getJobFreshnessMeta,
  getJobNextAction,
  getJobSignalNotes,
  getStoredMobileBoardStage,
  initCountUp,
  initDashboardReveal,
  isHighFitTodo,
  isResumeReadyJob,
  ...
  renderBoard,
  renderBoardListView,
  renderCareerOsActionQueue,
  renderCareerOsEmptyState,
  ...
  renderDevelopmentUI,
  renderEmptyState,
  renderInlineErrorState,
  renderInsights,
  renderJobCard,
  renderJobDetailsFlyout,
  renderJobFlyoutActions,
  renderJobFreshnessBadge,
  renderJobIntelligence,
  renderJobRadarCockpit,
  renderJobSourceHealthPanel,
  renderJobTableRow,
  renderLog,
  renderMobileRadarActionBar,
  renderPager,
  renderPremiumReleaseFocusSection,
  renderPremiumRoadmapSection,
  renderProfileMatchPage,
  renderRadarEmptyState,
  renderReleaseCard,
  renderReleaseCenterPage,
  renderReleaseStudyActionSection,
