// Version: 2026-04-21-T1430 (High-Fidelity Vector Mode)
// =============================================
console.log('%c Dashboard Version: 2026-04-21-T1430 (v1368)', 'color: #10b981; font-weight: bold; font-size: 14px;');
...
function renderProfileMatchPage(profile) {
  ...
  if (topics.length > 0) {
    html += '<div style="margin-bottom:20px;"><div style="font-weight:700;font-size:0.9rem;color:var(--text);margin-bottom:10px; display:flex; align-items:center; gap:8px;">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;color:var(--blue);"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>' +
      'AI Recommended Study Topics</div>';
    html += '<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px;">';
    topics.forEach(function(t) {
      var topicName = t.topic || t.name || t.id || t.title || t.label || t.subject || t.topicName || 'Specialized Topic';
      ...
      html += '<div style="font-size:0.68rem;color:var(--dim);display:flex;justify-content:space-between; align-items:center;">' +
        '<span style="display:flex; align-items:center; gap:4px;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:12px;height:12px;"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> ' + (t.estimatedHours || 0) + 'h estimated</span>';
      html += '<span style="color:var(--blue); display:flex; align-items:center; gap:4px;">' +
