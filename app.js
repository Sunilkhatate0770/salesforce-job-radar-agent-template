...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (themeBtn && !themeBtn.dataset.themeBound) {
    ...
    themeBtn.addEventListener('click', () => {
      if (typeof window.toggleSfjrTheme === 'function') {
        window.toggleSfjrTheme();
        return;
      }
...
console.log('--- REACHED THE END OF APP.JS ---');

Object.assign(window, {
  DASHBOARD_VERSION,
  DATA_DRIVEN_TOPIC_IDS,
  GSI_TOKEN,
  JOB_RADAR_CSS,
  MIN_FETCH_INTERVAL,
  NAV_ICON_PATHS,
  ...
  RECENT_TOPIC_LIMIT,
  SCHEDULE_DATA,
  STATIC_TOPIC_FALLBACKS,
  TOPIC_DATA,
  TRACKER_KEY,
  VERSION,
  _originalStopTracking,
  addChatMessage,
  addJobIntelSkillCounts,
  apiFetch,
  applyUiMode,
  baseSeconds,
  ...
  filterJobsList,
  filterSidebar,
  floatingTimerInterval,
  formatAppDateTime,
  formatIsoTimestampsIn,
  formatTime,
  formatTimeFull,
  generateCoverLetter,
  generateDynamicQA,
  ...
  renderHistoryUI,
  renderJobsList,
  renderMockInterviewHistory,
  renderNavGroupChevron,
  renderNavIcon,
  renderPager,
  renderRecentTopicsPanel,
  renderSidebarNavItem,
  renderSidebarNavSections,
  renderSidebarNavigation,
  renderStreakBadge,
  renderTableView,
  renderTimelineView,
  ...
  sendToCoach,
  sessionFeedbackProvided,
  setBookmarksPage,
  setHistoryPage,
  setJobIntelPanelState,
  setJobRadarBadge,
  setJobRadarLoadingState,
  setJobRadarNotice,
  setLogPage,
  setOnlySidebarGroupOpen,
  setScopedItem,
  ...
  syncHistoryWithFeedback,
  syncLoginUiModeControls,
  syncSidebarRailFlyoutMode,
  syncSidebarStickyOffset,
  syncSidebarViewportMode,
  toggleBookmark,
